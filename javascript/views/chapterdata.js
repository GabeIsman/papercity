define(function() {
 return {
    '119059448': {
      ...
      thumbnailUrl: '/images/thumbs/american-dream.jpg',
      exercises: [
        {
    ...
    '119060790': {
      ...
      thumbnailUrl: '/images/thumbs/pursuit-of-happiness.jpg',
      exercises: [
        {
    ...
    '120338542': {
      ...
      thumbnailUrl: '/images/thumbs/war-on-drugs.jpg',
      exercises: [
        {
    ...
    '119653722': {
      ...
      thumbnailUrl: '/images/thumbs/prison-industrial-complex.jpg',
      exercises: [
        {
    ...
    '119653920': {
      ...
      thumbnailUrl: '/images/thumbs/chaos-or-community.jpg',
      exercises: [
        {
